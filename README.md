...
bashgit clone https://github.com/Javier2712A/Pyside6.git
cd Pyside6
...
El proyecto incluye capturas de pantalla que demuestran:

Interfaz principal de la aplicación
Proceso de validación de email
Mensajes de error y confirmación
Operaciones CRUD en funcionamiento
